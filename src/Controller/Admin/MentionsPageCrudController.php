...
class MentionsPageCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return MentionsPage::class;
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            FormField::addTab('Image'),
            ImageField::new('image', 'Image')
                ->setColumns(6)
                ->setBasePath('uploads/img/mentions')
                ->setUploadDir('public/uploads/img/mentions')
    ...
    {
        return $crud
            ->setPageTitle('index', 'Page Mentions Légales')
            ->setPageTitle('edit', 'Modifier la page Mentions Légales')
            ->setPageTitle('detail', 'Page Mentions Légales')
