...
class SearchPageCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            ImageField::new('image', 'Image')
                ->setColumns(6)
                ->setBasePath('uploads/img/recherche')
                ->setUploadDir('public/uploads/img/recherche')
    ...
    {
        return $crud
            ->setPageTitle('index', 'Page Recherche')
            ->setPageTitle('edit', 'Modifier la page Recherche')
            ->setPageTitle('detail', 'Page Recherche')
